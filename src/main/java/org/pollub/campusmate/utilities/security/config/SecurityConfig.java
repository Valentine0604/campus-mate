    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/addressBook").hasAnyRole("ADMIN", "LECTURER", "STUDENT")
                        .requestMatchers(HttpMethod.POST, "/api/addressBook").hasAnyRole("ADMIN", "LECTURER", "STUDENT")
                        .requestMatchers(HttpMethod.DELETE, "/api/addressBook/{addressBookId}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/addressBook/{addressBookId}").hasRole("ADMIN")
