    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/user/event/{userId}").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/event").hasAnyRole("ADMIN", "LECTURER")
                        ...
                        .requestMatchers(HttpMethod.GET, "api/schedule").hasAnyRole("ADMIN", "LECTURER", "STUDENT")
                        .requestMatchers(HttpMethod.POST, "api/schedule/upload").hasAnyRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "api/schedule/{groupName}").hasAnyRole("ADMIN")
